...
import yaml
from data_utils2021 import genSpoof_list,Dataset_ASVspoof2019_train,Dataset_ASVspoof2021_eval
from model2021 import RawGAT_ST
...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='/public/home/acal2okrm7997/wmnt/LA/LA/ASVspoof_LA_cm_protocols/', help='Change with path to user\'s LA database protocols directory address')
    '''
    % protocols_path/
    ...
    #database
    prefix      = 'ASVspoof2021_{}'.format(track)
